...
public class ServerStarter {
	...
	// 2013-4-26 17:52:16 add
	private static final String DIR_PREFIX = "D:/portal2_project/openfire/src"; // 我们新增加的一个BASE路径常量
	/**
	 * Default to this location if one has not been specified
	 */
	// private static final String DEFAULT_LIB_DIR = "../lib";
	// private static final String DEFAULT_ADMIN_LIB_DIR =
	 ...
	 */
	private void start() {
		//2013-4-26 18:05:13 add
		System.setProperty("openfireHome", DIR_PREFIX);
